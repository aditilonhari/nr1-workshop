  ...
  nrqlChartData(platformUrlState) {
    ...
    return [
      ...
      },
      {
        ...
        nrql: `SELECT count(*) FROM JavaScriptError SINCE ${durationInMinutes} MINUTES AGO COMPARE WITH ${durationInMinutes *
          2} MINUTES AGO`
      },
      {
      ...
      },
      {
        ...
        nrql: `SELECT uniqueCount(entityGuid) as 'Host Count' from SystemSample SINCE ${durationInMinutes} MINUTES AGO COMPARE WITH ${durationInMinutes *
          2} MINUTES AGO`
      }
    ];
  }
              ...
              >
                ...
                {selectedAccount && (
                  <StackItem>
                    ...
                    >
                      {this.nrqlChartData(platformUrlState).map((d, i) => (
                        <StackItem key={i} shrink={true}>
                          <h2>{d.title}</h2>
                          {d.chartType == "pie" ? (
                            <PieChart
